...
1. Heart Disease Assessment: For chest pain, shortness of breath, irregular heartbeat. (Link: http://localhost:8501)
2. Diabetes Risk Assessment: For frequent thirst, fatigue, blurred vision. (Link: http://localhost:8502)
3. Parkinson's Disease Assessment: For tremors, stiffness, voice changes. (Link: http://localhost:8503)
